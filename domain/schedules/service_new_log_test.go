...
func Test_timeTableService_NewLog(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := tr.NewLog(tt.args.f, tt.args.r, tt.args.ri, tt.args.p)
			if (err != nil) != tt.wantErr {
				t.Errorf("timeTableService.NewLog() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			tt.want.Id = got.Id
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("timeTableService.NewLog() = %v, want %v", got, tt.want)
			}
		})
	}
}
